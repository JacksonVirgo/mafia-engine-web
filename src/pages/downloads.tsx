...
export default function Downloads() {
	return (
		<>
			<Head>
				<title>Mafia Engine - Downloads</title>
			</Head>
			<main
			...
			>
				...
				<p className="px-4 text-center text-lg">
					Download our advertising app for MacOS and Windows
				</p>
...
function DownloadPanel({ name, link }: InfoPanelProps) {
	...
	return (
		...
		>
			...
			{link && (
				<span className="my-4 text-center text-xs underline hover:text-red-500 sm:text-sm">
					Download File
				</span>
			)}
			{!link && (
				<span className="my-4 text-center text-xs sm:text-sm">
					Coming Soon
				</span>
			)}
		</div>
...
//https://docs.google.com/uc?export=download&id=1zWsnYp12cja9U5RjbClMywH1qN2ke2xF
